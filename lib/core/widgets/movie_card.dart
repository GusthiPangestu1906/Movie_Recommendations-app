...
class _MovieCardState extends State<MovieCard>
  ...
  Widget build(BuildContext context) {
    ...
    final watchDate =
        widget.movie.watchDate ?? historyProvider.getWatchDate(widget.movie.id);

    if (watchDate != null && widget.movie.watchDate == null) {
      widget.movie.watchDate = watchDate;
    }

    Widget currentCard = GestureDetector(
        ...
        builder: (context, child) {
          ...
          return Transform(
            ...
            child: isBackVisible
                ...
                : StandardMovieCard(movie: widget.movie, onFlip: _toggleReveal),
          );
        },
      ),
    );
